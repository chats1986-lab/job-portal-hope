...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover roles matched to your skills and experience." },
      { property: "og:title", content: "HireMe — Find Your Next Opportunity" },
      { property: "og:description", content: "Discover roles matched to your skills and experience." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss, precedence: "high" },
